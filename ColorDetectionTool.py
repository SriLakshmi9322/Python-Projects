from tkinter import Tk, PhotoImage, Label, Frame, Canvas, GROOVE, Button
...
# Icon
image_icon = PhotoImage(file="Images/color_detector_icon.png")
...
hex1 = Label(colors1, text="#b8255f", fg="#000", font="arial 12 bold",
             bg="white")
hex1.place(x=60, y=15)

hex2 = Label(colors1, text="#db4035", fg="#000", font="arial 12 bold",
             bg="white")
hex2.place(x=60, y=65)

hex3 = Label(colors1, text="#ff9933", fg="#000", font="arial 12 bold",
             bg="white")
hex3.place(x=60, y=115)

hex4 = Label(colors1, text="#fad000", fg="#000", font="arial 12 bold",
             bg="white")
hex4.place(x=60, y=165)

hex5 = Label(colors1, text="#afb83b", fg="#000", font="arial 12 bold",
             bg="white")
...
hex6 = Label(colors2, text="#7ecc49", fg="#000", font="arial 12 bold",
             bg="white")
hex6.place(x=60, y=15)

hex7 = Label(colors2, text="#299438", fg="#000", font="arial 12 bold",
             bg="white")
hex7.place(x=60, y=65)

hex8 = Label(colors2, text="#6accbc", fg="#000", font="arial 12 bold",
             bg="white")
hex8.place(x=60, y=115)

hex9 = Label(colors2, text="#158fad", fg="#000", font="arial 12 bold",
             bg="white")
hex9.place(x=60, y=165)

hex10 = Label(colors2, text="#14aaf5", fg="#000", font="arial 12 bold",
              bg="white")
...
Button(selectImage, text="Select Image", width=12, height=1,
       font="arial 14 bold", command=showImage).place(x=10, y=300)
Button(selectImage, text="Find Colors", width=12, height=1,
       font="arial 14 bold", command=findColor).place(x=176, y=300)
